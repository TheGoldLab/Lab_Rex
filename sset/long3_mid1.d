...
{
	int task_index;
printf("start_trial before pr_start_trial \n");
	if(!pr_start_trial()) {
		pr_toggle_file(0);
		return(0);
	}

printf("start_trial after pr_start_trial \n");
...
int set_reward(void)
{
	...
	set_times("rewbitoff1", currentrew, -1);
	return(0);
}
...
/*		do timer_set1(1000,100,1500,300,0,0) */
	...
	*/
	...
	correctASL:
		...
		to rewardASL
	rewardASL:
		do pr_set_reward(1,10,10,1,10,10)		
