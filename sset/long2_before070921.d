...
int rew_by_RT( long slope10, long baseRT1, long baseRT2, long minRew, long maxRew)
{
	...
	if ( flag_asymRew==2 && slope10>0 ) 
	{	
	  	angle_cur = PL_G2PVS(gl_rec->dx->current_graphic, 1, 6, 0);
     	angle0 = TPMV("Angle_o");
		baseRT = baseRT2;	
		if (angle_cur == angle0) baseRT = baseRT1;
		
		tempRew = (double)currentrew + (timesac - timego - baseRT) * slope10 / 10.0;		
...
*/		
	...
	rewarddelay_dots:
		do rew_by_RT(50, 420, 400, 300, 1000)	
