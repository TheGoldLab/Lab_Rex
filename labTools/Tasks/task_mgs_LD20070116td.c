...
*/
/*
** TD 2015-05-18. Added a menu variable nreward  
*/
...
/* PRIVATE ROUTINES */
void 		mgs2_make_trials	(_PRtask);
_PRtrial mgs2_get_trial	(_PRtask, int);
void 		mgs2_set_trial	(_PRtrial);
...
struct _TAtask_struct gl_mgs2_task[] = {
...
**
*/
void mgs2_make_trials(_PRtask task)
{
...
**		NULL otherwise
*/
_PRtrial mgs2_get_trial(_PRtask task, int reset_flag)	
{
...
**	 above changes.
*/
void mgs2_set_trial(_PRtrial trial)
{
